package com.lczy.payment.alipay.util;
...
import com.lczy.payment.alipay.sign.MD5;
import com.lczy.payment.alipay.util.httpClient.HttpProtocolHandler;
import com.lczy.payment.alipay.util.httpClient.HttpRequest;
import com.lczy.payment.alipay.util.httpClient.HttpResponse;
import com.lczy.payment.alipay.util.httpClient.HttpResultType;
...
public class AlipaySubmit {
    ...
    public static String signRequest(Map<String, String> sParaTemp) {
        //待请求参数数组
        Map<String, String> sPara = buildRequestPara(sParaTemp);
        List<String> keys = new ArrayList<String>(sPara.keySet());
        ...
        return ALIPAY_GATEWAY_NEW + StringUtils.join(params, "&");
    }
