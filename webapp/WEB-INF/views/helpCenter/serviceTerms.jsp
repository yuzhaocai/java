...
<!--=== End Header v1 ===-->
        ...
        <div class="panel panel-default">
        	<div class="panel-heading h4"><i class="ico-vline"></i>服务条款</div>
...
第八条 知识产权
1、采媒在线平台由采媒在线独立开发或获得授权许可。采媒在线所提供的网络交易服务的相关著作权、专利权、商标权、营业机密及其它任何所有权或权利，均属北京媒立方传媒科技有限公司所有。包括但不限于：文字表述及其组合、图标、图饰、图表、色彩、界面设计、版面框架、音频及或视频资料、电子文档、技术、所有程序、产品及服务名称等均受知识产权法律法规的保护。
