    ...
    <div class="sys-media">
        <div class="bg-grey border p-xs m-b-xs">
            ...
            <div class="media-body m-b-xs">
                ...
                <div class="row">
                    <div class="col-md-12"><span class="text-muted col-md-3">微信号：</span>${media.account }</div>
                </div>
                </c:if>
                <div class="row">
                ...
                <c:if test="${not empty media.fansDir}">
                <div class="row">
                    <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <span class="text-muted col-md-3">标签：</span>
						${media.tags }
					</div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="border-dotted p-xs m-b-xs">
                    ...
                    <div class="row">
                        <div class="col-md-6"><span class="text-muted">案例标题：</span>${item.title }</div>
                        <div class="col-md-6"><span class="text-muted">案例亮点：</span>${item.light }</div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                        <span class="text-muted">案例正文：</span><br>${item.content }
                        </div>
                    </div>
                    <hr class="hr-xs">
                    </c:forEach>
