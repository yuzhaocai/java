  ...
  <div class="panel-body"><!-- 右侧主体内容 -->
    <div class="row">
			...
			<div class="col-md-8" id="func-form" ><!-- 表单 -->
				...
				<form id="form1" action="${ctx}/admin/role/perms/${role.id}" method="post" class="form-horizontal">
...
$(function() {
	...
	//加载角色的权限id
	var rfids = [];
	$.ajax('${ctx}/admin/role/perms/${role.id}/json', {
		async : false
		, dataType : 'json'
	...
	$('#submit_btn').on('click', function() {
		var url = '${ctx}/admin/role/perms/${role.id}';
		var fids = [];
