  ...
  aria-labelledby="newDicModalLabel" aria-hidden="true">
    ...
    <zy:token/>
      ...
      <div class="modal-header"> <!-- modal-header -->
        ...
        <c:if test="${empty dic.id}">新建</c:if>
        <c:if test="${!empty dic.id}">修改</c:if>-字典类别</h4>
      ...
      <div class="modal-body"><!-- modal-body -->
          ...
          <input id="id" type="hidden" name="dicId" value="${dic.id }" />
          ...
          <div class="form-group form-group-sm">
            ...
            <div class="col-sm-6 has-feedback">
              <input type="text" class="form-control required" id="dicCode" name="dicCode" value="${dic.dicCode }"
                 maxLength="20" <c:if test="${!empty dic.id }">readonly</c:if> />
            </div>
          </div>
          <div class="form-group form-group-sm">
