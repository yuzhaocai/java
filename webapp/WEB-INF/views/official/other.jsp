...
<div class="breadcrumbs">
	<div class="container">
        ...
        <ul class="breadcrumb">
        	...
        	<li><c:out value="${otherName}"></c:out></li>
        </ul>
        </div>
    </div>
</div>
...
<div class="container">
    <div class="row">
        ...
        <div class="right-panel">
            <div class="headline">
            	<h4><c:out value="${otherName}"></c:out>官方媒体筛选</h4>
            </div>
            <div class="screening">
            ...
            <ul class="prod-list-v2 clearfix" id="otherMedias">
				...
				<li>
					<div class="thumbnail">
						<a target="_blank" href="${ctx }/other/view/${item.id }">
							<img src="${item.showPic }">
						</a>
						<div class="caption text-center">
							<h3>
								<a target="_blank" href="${ctx }/other/view/${item.id }">${item.name }</a>
							</h3>
						</div>
					</div>
				</li>
...
<li>
    <div class="thumbnail">
        <a target="_blank" href="${ctx }/other/view/{id}">
            <img src="{showPic}">
        </a>
        <div class="caption text-center">
            <h3>
                <a target="_blank" href="${ctx }/other/view/{id}">{name}</a>
            </h3>
        </div>
    </div>
</li>
