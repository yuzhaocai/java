        ...
        <div class="left-panel">
            <div class="panel panel-default">
                ...
                <div id="leftBar" class="list-group">
                    <a href="${ctx }/official/weixin" class="list-group-item">微信</a>
                    <a href="${ctx }/official/weibo" class="list-group-item active">微博</a>
	...
	<li>
	    <div class="thumbnail thumbnail-display">
			<div class="photo-wrap">
		        <a href="${ctx}/weibo/detail/{id}">
		            <img src="{showPic}" class="photo">
		            <span class="photo-mask"></span>
		        </a>
				<button type="button" onclick="location='${ctx}/weibo/detail/{id}#e'">查看报价</button>
			</div>
	        <div class="thumbnail-block caption">
	            <h1 class="thumbnail-title"><a href="${ctx}/weibo/detail/{id}">{name}</a></h1> 
	        ...
	        <div class="thumbnail-block">
	        	<hr>
	            <p class="thumbnail-text">简介：<span>{description}</span><a href="${ctx}/weibo/detail/{id}#a">[详情]</a></p>
	        </div>
	    </div> 
...
<form id="search-form" action="${ctx}/weibo/load">
