...
<form id="yanshou-form" action="${ctx}/member/order/advertiser/acceptance" method="post">
	...
	<div class="modal-body">
		<c:if test="${!empty deliverable }">
			<div class="row">
				<div class="col-xs-6">
					标题：${deliverable.order.requirement.name }
				</div>
				<div class="col-xs-6">
	...
	<div class="modal-footer">
		<button class="btn-u btn-u-red" type="submit" id="btn-yanshou-pass">验收通过</button>
	</div>
</form>
...
<script type="text/javascript">
	...
	function view(pic) {
		$yanshouModal = $('#yanshou');
		$('#viewCheckModal').loadModalNow(
				'${ctx}/member/order/advertiser/view?ajax', {
					pic : pic
				},$yanshouModal);
	}
</script>
