	...
	<div class="sys-media">
		<div class="bg-grey border p-xs m-b-xs">
			<div class="media-body m-b-xs">
				...
				<div class="row">
					<div class="col-md-6">
						<span class="text-muted">预计开始时间：</span>
				...
				<div class="row">
					<div class="col-md-6">
						<span class="text-muted">响应截止时间：</span>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="border-dotted p-xs m-b-xs">
					...
					<div class="row">
						<div class="col-lg-12">${req.summary }</div>
					</div>
				</div>
			</div>
		</div>
...
<script src="../assets/plugins/jquery/1.11.2/jquery.min.js"></script>
