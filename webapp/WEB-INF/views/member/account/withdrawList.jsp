	    ...
	    <%@include file="/WEB-INF/views/member/account/accountInfo.jsp" %>
         ...
         <div class="pad mtab-v2">
             ...
             <div class="tab-content">
                 <div class="tab-pane active" id="withdraw-records">
                   	<div class="topwrap">
                        <form class="form-inline" action="${ctx }/member/account/withdrawList">
                     ...
                     <table class="table table-bordered table-striped" width="100%">
                     	<thead>
                           <tr>
                             ...
                             <th scope="col" width="30%">提现时间</th>
                             <th scope="col" width="20%">提现金额</th>
