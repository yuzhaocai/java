...
<body>
  ...
  <div class="main-panel">
      <div class="headline"><h5>创建新需求 - 填写定制要求</h5></div>     
      <!-- mTab v2 -->          
      <div class="pad pd15">
							...
							<div class="col-sm-9 col-xs-offset-1">
					           ...
					           <fieldset>
						              <div class="form-group">
					                   ...
					                   <div class="col-sm-4"><p class="form-control-static"><zy:dic value="${req.industryTypes }"/> </p></div>
						              </div>
						              <div class="form-group">
						                  ...
						                  <div class="col-sm-10 has-feedback">
						                      ...
						                      <p class="text-warning"><small>您的需求和素材将会受到隐私保护，不会公开到网站上，采媒在线专业文案策划团队将与您联系！</small></p>
						                  </div>
						              </div>
						              <div class="form-group form-group-sm">
						                  <label class="control-label col-sm-2"><span class="color-red">*</span>素材:</label>
						                  <div class="col-sm-4 has-feedback">
							                  <p class="form-control-static">
							                      <input type="file" name="articleMatterFile">                  	
							                  </p>
						                      <p class="text-warning"><small>仅支持图片和word/pdf文档</small></p>
										  </div>
						                  <label class="control-label col-sm-2">资质证明:</label>
						                  <div class="col-sm-4">
							                  	<p class="form-control-static">
							                      <input type="file" name="certImgFile">
							                    </p>
						              ...
						              <div class="form-group">
						                  ...
						                  <div class="col-sm-4 has-feedback">
						                      <input type="text" class="form-control Wdate " placeholder="最迟响应时间" id="deadline" name="deadline" value="${param.deadline }"
...
<script type="text/javascript">
	...
	$(function() {
		...
		$.validator.setDefaults({ ignore: ":hidden:not(select)" }); //解决 select-modal 插件冲突的问题
		...
		$('#create-form').validate({
			...
			messages: {
				articlePrice: {
					digits:'只能输入整数',
					rangelength: '请输入2~10个数字'
				},
				summary: {
					rangelength: '请输入2~2000个字符'
				}
			}
		});
