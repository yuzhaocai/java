...
<div class="main-panel">
    ...
    <div class="pad pd15">
        ...
        <form id="create-form" class="form-horizontal" enctype="multipart/form-data"
        	action="${ctx}/member/req/advertiser/create/finishCart" method="post">
            <zy:token/>
			<input type="hidden" name="hasArticle" value="true">
			<c:forEach items="${req.quotes }" var="item" varStatus="stat">
			<input type="hidden" class="quotes" name="quotes[${stat.index }].id"    value="${item.id }" >
				...
				<div class="row">
					<div class="col-sm-9 col-xs-offset-1">
		               ...
		               <div class="form-group form-group-sm">
		                   	...
		                   	<div class="col-sm-4 has-feedback">
			                   	<select class="hide select-modal" name="industryTypes" id=""
			                    	multiple="multiple"
		                  			data-title="选择行业类型">
			            ...
			            <div class="form-group form-group-sm">
			                ...
			                <div class="col-sm-4 has-feedback"> 
				                ...
				                <p class="text-warning">
				                    <small>若选择公开，将显示在需求广场频道并允许其他非邀媒体进行抢单。</small>
				                </p>
			                </div>
			            </div>
			            <div class="form-group form-group-sm">
