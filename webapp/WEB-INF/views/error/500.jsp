...
<meta name="decorator" content="printable" />
    ...
    <script src="${ctx}/static/legacy/js/jquery.min.js" type="text/javascript"></script>
	<link href="${ctx}/static/legacy/css/bootstrap.css" rel="stylesheet" />
...
<h2>500 - 系统发生内部错误. <small><a href="javascript:back()">返回上一页</a></small></h2>
