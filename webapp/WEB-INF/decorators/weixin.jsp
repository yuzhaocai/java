...
<meta name="keywords" content="<c:if test="${media.name != null}">${media.name},</c:if>微信频道,微信营销平台,微信公众号,微信营销成功案例">
...
<c:choose>
	...
	<c:otherwise>
		<title>采媒在线微信营销,微信营销平台,如何做好微信营销_采媒在线<%-- <decorator:title/>--%></title>
	</c:otherwise>
</c:choose>
